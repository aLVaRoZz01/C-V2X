...
void SNavigatorReceiver::handleMessage(cMessage *msg)
{
    ...
    // read VoIP header
    auto voipHeader = pPacket->popAtFront<SNavigatorPacket>();
...
void SNavigatorReceiver::playout(bool finish)
{
    ...
    SNavigatorPacket* pPacket = mPacketsList_.front();
...
double SNavigatorReceiver::eModel(simtime_t delay, double loss)
{
...
void SNavigatorReceiver::finish()
{
