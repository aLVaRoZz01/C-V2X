...
#ifndef __INET_SNAVIGATORPACKETSERIALIZER2_H
#define __INET_SNAVIGATORPACKETSERIALIZER2_H
 ...
 */
class SNavigatorPacketSerializer2 : public inet::FieldsChunkSerializer
{
  protected:
  ...
  public:
    SNavigatorPacketSerializer2() : FieldsChunkSerializer() {}
};
