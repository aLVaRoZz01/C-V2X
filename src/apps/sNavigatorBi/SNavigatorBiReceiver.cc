...
#include "apps/sNavigatorBi/SNavigatorBiReceiver.h"
#include "inet/common/INETDefs.h"
#include <omnetpp.h>

Define_Module(SNavigatorBiReceiver);

using namespace std;
using namespace inet;

SNavigatorBiReceiver::~SNavigatorBiReceiver()
{
...
void SNavigatorBiReceiver::initialize(int stage)
{
...
void SNavigatorBiReceiver::handleMessage(cMessage *msg)
{
    ...
    auto sNavigatorHeader = pPacket->popAtFront<SNavigatorBiPacket>();
