...
#ifndef __INET_SNAVIGATORBIPACKETSERIALIZER_H
#define __INET_SNAVIGATORBIPACKETSERIALIZER_H
 ...
 */
class SNavigatorBiPacketSerializer : public inet::FieldsChunkSerializer
{
  protected:
  ...
  public:
    SNavigatorBiPacketSerializer() : FieldsChunkSerializer() {}
};
